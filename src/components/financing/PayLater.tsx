        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-6">
            ...
            <p className="mt-6 text-[16px] md:text-[18px] leading-[1.55] text-[#050505]/80 max-w-[52ch]">
              Mit der <span className="font-semibold">Qonto Ratenzahlung</span>{" "}
              werden Ihre Rechnungen sofort beglichen – Sie zahlen den Betrag
              später zurück.
            </p>
            <ul className="mt-8 space-y-4 text-[15px] md:text-[16px] leading-[1.5] text-[#050505]/85">
              <li className="flex gap-3">
                ...
                Teilen Sie Zahlungen in bis zu 12 Raten.
              </li>
              <li className="flex gap-3">
                <span className="mt-1.5 inline-block w-1.5 h-1.5 rounded-full bg-[#050505]" />
                Investieren Sie in Ihr Wachstum, ohne Ihr Budget zu belasten.
              </li>
            </ul>
