...
export const landingPages: LandingPage[] = [
  ...
  {
    slug: "social-media",
    metaTitle: "Social Media, Content & Eventbegleitung",
    metaDescription:
      "Social-Media-Strategie, Foto- und Videoproduktion sowie Eventbegleitung – von der Idee bis zum plattformfertigen Content.",
    hero: {
      eyebrow: "Landingpage · Social Media",
      headingLines: ["Content,", "der sichtbar macht."],
      subline:
        "Strategie, Foto, Video und Eventbegleitung aus einer Hand. Wir entwickeln Inhalte, produzieren vor Ort und liefern sie plattformfertig für Ihre Kanäle.",
      primaryCta: { label: "Projekt anfragen", href: "/kontakt" },
      secondaryCta: { label: "Kostenlose Checkliste", href: "#checkliste" },
    ...
    stats: [
      { big: "1×", label: "Strategie & Produktion" },
      { big: "Foto +", label: "Video aus einer Hand" },
      { big: "Live", label: "Eventbegleitung vor Ort" },
    ],
    features: {
      eyebrow: "Was Sie bekommen",
      headingLines: ["Vier Bausteine,", "für sichtbaren Content."],
      items: [
        {
          icon: "compass",
          title: "Strategie & Formate",
          body: "Positionierung, Themen, Hooks und Kanäle – abgestimmt auf Zielgruppe, Angebot und klare Content-Ziele.",
        },
        {
          icon: "palette",
          title: "Foto & Video",
          body: "Drehtage, Reels, Shorts, Interviews und authentische Einblicke – professionell vorbereitet und produziert.",
        },
        {
          icon: "calendar",
          title: "Eventbegleitung",
          body: "Stories, Fotocontent, Statements, Recaps und Aftermovies direkt von Ihrem Event.",
        },
        {
          icon: "rocket",
          title: "Schnitt & Ausspielung",
          body: "Sound, Untertitel und plattformgerechte Formate – bereit für Instagram, LinkedIn, TikTok und Shorts.",
        },
      ],
    ...
    checklist: {
      eyebrow: "Kostenlos",
      headingLines: ["Die Content-", "Checkliste", "für Ihren Auftritt."],
      body: "Eine kompakte Checkliste, mit der Sie Themen, Formate, Produktion und Ausspielung für Ihren Social-Media-Auftritt prüfen.",
      formSource: "lp-social-media",
      sideTitle: "Direkt-Download",
      sideBody: "E-Mail eintragen, Checkliste herunterladen.",
    },
    finalCta: {
      heading: "Bereit für Content, der wirklich eingesetzt wird?",
      body: "Ein unverbindliches Erstgespräch – wir klären Ziel, Formate und ob Produktionstag, laufende Begleitung oder Event-Content am besten passt.",
      ctaLabel: "Jetzt anfragen",
    },
  },
